package zhangyanran201800924.bwie.com.jineng.adapter;
...
import zhangyanran201800924.bwie.com.jineng.hodel.ShopCartHolder;
...
public class ShopCartAdapter extends RecyclerView.Adapter<ShopCartHolder> {
    Context context;
    List<NewBean.DataBean.ListBean> data;

    public ShopCartAdapter(Context context, List<NewBean.DataBean.ListBean> data) {
